package com.example.dz1.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(requests -> requests
                                ...
                                .requestMatchers("/comments/get/all").hasAnyRole("MODER", "ADMIN")
                                .requestMatchers("/posts/delete/**").hasRole("ADMIN")
                                .requestMatchers("/subjects/delete/**").hasRole("ADMIN")
                                .requestMatchers("/subjects/create").hasRole("ADMIN")
                                .requestMatchers("/comments/delete/**").hasAnyRole("MODER", "ADMIN")
                                ...
                                .requestMatchers("/news/create").hasAnyRole("MODER", "ADMIN")
